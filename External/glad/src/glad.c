/*
    ...
    OpenGL loader generated by glad 0.1.36 on Tue Jan 16 19:29:36 2024.
    ...
    Commandline:
        --profile="core" --api="gl=4.5" --generator="c" --spec="gl" --extensions="GL_ARB_bindless_texture,GL_ARB_clear_texture,GL_ARB_copy_image,GL_ARB_depth_texture,GL_ARB_spirv_extensions,GL_ARB_texture_barrier,GL_ARB_texture_border_clamp,GL_ARB_texture_compression,GL_ARB_texture_cube_map,GL_ARB_texture_cube_map_array,GL_ARB_texture_filter_anisotropic,GL_ARB_texture_rectangle,GL_ARB_texture_rg,GL_EXT_debug_label,GL_EXT_debug_marker,GL_EXT_draw_buffers2,GL_EXT_draw_instanced,GL_EXT_external_buffer,GL_EXT_fog_coord,GL_EXT_framebuffer_blit,GL_EXT_framebuffer_blit_layers,GL_EXT_framebuffer_multisample,GL_EXT_framebuffer_multisample_blit_scaled,GL_EXT_framebuffer_object,GL_EXT_framebuffer_sRGB,GL_EXT_index_texture,GL_EXT_texture,GL_EXT_texture3D,GL_EXT_texture_array,GL_EXT_texture_filter_anisotropic,GL_EXT_texture_integer,GL_EXT_texture_lod_bias"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.5&extensions=GL_ARB_bindless_texture&extensions=GL_ARB_clear_texture&extensions=GL_ARB_copy_image&extensions=GL_ARB_depth_texture&extensions=GL_ARB_spirv_extensions&extensions=GL_ARB_texture_barrier&extensions=GL_ARB_texture_border_clamp&extensions=GL_ARB_texture_compression&extensions=GL_ARB_texture_cube_map&extensions=GL_ARB_texture_cube_map_array&extensions=GL_ARB_texture_filter_anisotropic&extensions=GL_ARB_texture_rectangle&extensions=GL_ARB_texture_rg&extensions=GL_EXT_debug_label&extensions=GL_EXT_debug_marker&extensions=GL_EXT_draw_buffers2&extensions=GL_EXT_draw_instanced&extensions=GL_EXT_external_buffer&extensions=GL_EXT_fog_coord&extensions=GL_EXT_framebuffer_blit&extensions=GL_EXT_framebuffer_blit_layers&extensions=GL_EXT_framebuffer_multisample&extensions=GL_EXT_framebuffer_multisample_blit_scaled&extensions=GL_EXT_framebuffer_object&extensions=GL_EXT_framebuffer_sRGB&extensions=GL_EXT_index_texture&extensions=GL_EXT_texture&extensions=GL_EXT_texture3D&extensions=GL_EXT_texture_array&extensions=GL_EXT_texture_filter_anisotropic&extensions=GL_EXT_texture_integer&extensions=GL_EXT_texture_lod_bias
*/
