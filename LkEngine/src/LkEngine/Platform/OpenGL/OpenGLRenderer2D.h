...
namespace LkEngine {
    ...
    inline static Ref<Shader> ScreenShader;
    inline static Ref<Shader> DebugShader;

    unsigned int& GetFramebuffer();
    unsigned int& GetTextureColorBufferID();
    ...
    static Ref<Shader> GetDebugShader() { return DebugShader; }
    static Ref<Shader> GetScreenShader() { return ScreenShader; }
